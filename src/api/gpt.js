export const callGpt = async ({ prompt }) => {
  const messages = [
    ...
    },
    {
      ...
      7. [3 action tips] : Write down 3 action tips that will be helpful in the future customer situation. The three action tips must beconverted into JSON Array format.But please exclude the numbering.
